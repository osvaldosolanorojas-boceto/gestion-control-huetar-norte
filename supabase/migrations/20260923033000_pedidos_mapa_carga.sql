-- Solo datos operativos para personal de planta: precios y montos no se exponen.
...
begin
  ...
  return query select l.id,o.id,o.codigo,o.contenedor,c.nombre,l.producto,l.presentacion_kg,
    l.cantidad_cajas,l.paletas,l.cajas_por_paleta,l.carton_marca
  from public.ordenes_venta_lineas l join public.ordenes_venta o on o.id=l.orden_venta_id
  left join public.clientes c on c.id=o.cliente_id
  order by o.fecha desc,o.creado_en desc,l.id limit 1000;
end;
$$;
