-- Precio único del ñampí a rendimiento y deducción única por orden de compra.
alter table public.ordenes_compra add column rebaja_planilla_flete numeric(16,2) not null default 0 check (rebaja_planilla_flete >= 0);
...
select 'compra_campo'::text origen,o.id origen_id,o.codigo,o.fecha,
  ...
  greatest(0,coalesce(sum(b.monto_cxp),0)-coalesce(o.rebaja_planilla_flete,0))::numeric(16,2) monto,
