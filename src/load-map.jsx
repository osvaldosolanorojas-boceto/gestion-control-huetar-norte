...
export default function LoadMap({go}){
  ...
  useEffect(()=>{reload()},[])
  const orders=useMemo(()=>[...new Map(lines.map(x=>[x.orden_id,{id:x.orden_id,codigo:x.codigo,cliente:x.cliente,numero_cliente:x.numero_cliente,fecha_salida:x.fecha_salida,contenedor:x.contenedor}])).values()],[lines])
