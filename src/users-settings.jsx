...
export default function UsersSettings({profile}){
  ...
  return <div className="users-settings">
    <div className="users-intro"><div><span>CONFIGURACIÓN · USUARIOS</span><h2>Usuarios y permisos</h2><p>Prepare los accesos de planta, oficina y finca. Puede anotar a las 10 o 12 personas aunque todavía no tenga todos los correos.</p></div><button className="primary" type="button" onClick={()=>{setError('');setEditing({...empty,modulos:[...empty.modulos]})}}><Plus size={18}/>Preparar usuario</button></div>
    ...
    <div className="notice">Estos son borradores para revisar permisos. Guardarlos no envía invitaciones ni permite iniciar sesión. Los módulos seleccionados todavía no son permisos efectivos. Cada persona creará su propia contraseña cuando se activen las invitaciones.</div>
