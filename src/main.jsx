...
const nav = [
  ['Resumen', LayoutDashboard], ['Boletas de entrada', Truck], ['Órdenes de compra', ShoppingCart], ['Órdenes de venta', PackageCheck],
  ['Producción y rendimientos', Factory], ['Mapa de carga', PackageCheck], ['Saldo de yuca en planta', PackageCheck], ['Segundas y rechazo', PackageCheck], ['Empresas', Landmark],
