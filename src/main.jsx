...
const nav = [
  ...
  ['Inventarios', PackageCheck], ['Finanzas', WalletCards], ['Bancos', Landmark], ['Corte semanal', CircleDollarSign], ['Fincas', PackageCheck]
]
