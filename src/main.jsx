...
function Module({title,role,search,setSearch,onNew,onEdit,refresh}){
  ...
  useEffect(()=>{setWeek(title==='Órdenes de compra'?'all':weekOf(new Date()));setHistory(false);setVoided(false)},[title])
